...
pred composition [r1: univ->univ, r2: univ->univ] {r1.r2 in iden}
...
/** GTRI Update: r is asymmetric */
pred asymmetric [r: univ -> univ] {no r & ~r} // Could also use "irreflexive[r] and antisymmtric[r]"

/** r is transitive */
pred transitive [r: univ -> univ] {r.r in r}

/** GTRI Update: r is atransitive */
pred atransitive[r: univ -> univ] {r.r not in r}
