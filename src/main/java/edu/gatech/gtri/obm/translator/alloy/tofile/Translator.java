  ...
  public void generateAlsFileContents(AlloyModule alloyModule, String outFilename) {
    ...
    for(Command command : commands) {
    	...
    	for(Func func : command.formula.findAllFunctions()) {
    		...
    		if(ignoredFuncs.contains(func) || 
			visitedFuncs.contains(func.toString())) {
          	  continue;
            }
            ...
            if (func.isPred) {
              sb.append("pred ")
              .append(MyAlloyLibrary.removeSlash(func.label));
              ...
              sb.append(": ")
              .append(MyAlloyLibrary.removeSlash(exprVisitor.visitThis(func.returnDecl)))
              .append(" {")
              .append(MyAlloyLibrary.removeSlash(exprVisitor.visitThis(func.getBody())))
              .append("}\n");
            }
