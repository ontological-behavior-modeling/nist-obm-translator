...
public class ConnectorsHandler {
  ...
  protected ConnectorsHandler(SysMLAdapter sysMLAdapter, SysMLUtil _sysmlUtil,
    ...
    this.parameterFields = _parameterFields; // pass from OBMXMI2Alloy and used during process method
  ...
  private void processConnectorsForAClass(Class ne) {
    ...
    // add transferFieldNames for this Class(ne), now stepPorpertiedBySig has transfer fields later used in OBMXMI1Alloy
