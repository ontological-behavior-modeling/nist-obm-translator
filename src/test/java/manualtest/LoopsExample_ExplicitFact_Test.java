...
class LoopsExample_ExplicitFact_Test {
  ...
  void test() {
    ...
    Func stepFunctions = Helper.getFunction(Alloy.transferModule, "o/steps");
    ...
    Expr instancesDuringExampleExpr = p1DuringExampleExpr.and(p2DuringExampleExpr)
        .and(p3DuringExampleExpr).and(p4DuringExampleExpr);
    ...
    Command loopCmd = new Command(null, loopExpr, "loop", false, 12, -1, -1, -1, List.of(),
        List.of(), loopExpr.and(alloy.getOverAllFact()), null);

    Command[] commands = new Command[] {loopCmd};

    // ========== Write file ==========

    AlloyModule alloyModule = new AlloyModule("LoopsExample_ExplicitFact", alloy.getAllSigs(),
