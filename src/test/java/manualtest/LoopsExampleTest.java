...
class LoopsExampleTest {
  ...
  void test() {
    ...
    Command loopCmd = new Command(null, loopExpr, "loop", false, 12, -1, -1, -1, new ArrayList<>(),
        new ArrayList<>(), loopExpr.and(alloy.getOverAllFact()), null);
    ...
    AlloyModule alloyModule =
        new AlloyModule("LoopsExample", alloy.getAllSigs(), alloy.getOverAllFact(), commands);
