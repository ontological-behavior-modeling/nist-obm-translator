...
public class ExpressionComparator {
  ...
  private boolean compareCommand(Command _command1, Command _command2) {
    ...
    if (_command1.additionalExactScopes.size() != _command2.additionalExactScopes.size()) {
      System.err.println("compareCommand: " + "c1.additionalExactScopes.size() != "
          + "c2.additionalExactScopes.size() (" + _command1.additionalExactScopes.size() + " vs. "
    ...
    if (_command1.bitwidth != _command2.bitwidth) {
      System.err
          .println("compareCommand: c1.bitwidth != c2.bitwidth (" + _command1.bitwidth + " vs. "
              + _command2.bitwidth + ")");
      return false;
    }
    ...
    if (_command1.check != _command2.check) {
      System.err
          .println("compareCommand: c1.check != c2.check (" + _command1.check + " vs. "
              + _command2.check + ")");
      return false;
    }
    ...
    if (_command1.expects != _command2.expects) {
      System.err.println(
          "compareCommand: c1.expects != c2.expects (" + _command1.expects + " vs. "
              + _command2.expects + ")");
      return false;
    }
    ...
    if (!compareExpr(_command1.formula, _command2.formula)) {
      System.err
          .println("compareCommand: " + "!compareExpr(c1.formula, c2.formula) (" + _command1.formula
              + " vs. " + _command2.formula + ")");
      return false;
    }
    ...
    if (!_command1.label.equals(_command2.label)) {
      System.err.println(
          "compareCommand: !c1.label.equals(c2.label) (" + _command1.label + " vs. "
              + _command2.label + ")");
      return false;
    }
    ...
    if (_command1.maxseq != _command2.maxseq) {
      System.err.println(
          "compareCommand: c1.maxseq != c2.maxseq (" + _command1.maxseq + " vs. " + _command2.maxseq
              + ")");
      return false;
    }
    // int maxstring
    if (_command1.maxstring != _command2.maxstring) {
      System.err
          .println("compareCommand: c1.maxstring != c2.maxstring ( " + _command1.maxstring + " vs. "
              + _command2.maxstring + ")");
      return false;
    }
    // int overall
    if (_command1.overall != _command2.overall) {
      System.err.println(
          "compareCommand: c1.overall != c2.overall (" + _command1.overall + " vs. "
              + _command2.overall + ")");
      return false;
    }
    // Command parent
    if (!compareCommand(_command1.parent, _command2.parent)) {
      System.err
          .println("compareCommand: " + "!compareCommand(c1.parent, c2.parent) (" + _command1.parent
              + " vs. " + _command2.parent + ")");
      return false;
    }
    // Pos pos (ignore)
    ...
    if (_command1.scope.size() != _command2.scope.size()) {
      System.err.println("compareCommand: " + "c1.scope.size() != c2.scope.size() ("
          + _command1.scope.size() + " vs. " + _command2.scope.size() + ")");
      return false;
    }
  ...
  private boolean compareCommandScope(CommandScope _commandscope1, CommandScope _commandscope2) {
    ...
    if (_commandscope1.endingScope != _commandscope2.endingScope) {
      System.err.println("compareCommandScope: " + "cs1.endingScope != cs2.endingScope ("
          + _commandscope1.endingScope + " vs. " + _commandscope2.endingScope + ")");
      return false;
    }
    // int increment
    if (_commandscope1.endingScope != _commandscope2.endingScope) {
      System.err.println("compareCommandScope: " + "cs1.increment != cs2.increment ("
          + _commandscope1.increment + " vs. " + _commandscope2.increment + ")");
      return false;
    }
    ...
    if (_commandscope1.isExact != _commandscope2.isExact) {
      System.err
          .println("compareCommandScope: " + "cs1.isExact != cs2.isExact (" + _commandscope1.isExact
              + " vs. " + _commandscope2.isExact + ")");
      return false;
    }
    // Pos pos (ignored)
    ...
    if (_commandscope1.startingScope != _commandscope2.startingScope) {
      System.err.println("compareCommandScope: " + "cs1.startingScope != cs2.startingScope ("
          + _commandscope1.startingScope + " vs. " + _commandscope2.startingScope + ")");
      return false;
    }
    return true;
  }
  ...
  private boolean compareDecl(Decl _decl1, Decl _decl2) {
    ...
    if (_decl1 == null && _decl2 == null) {
      System.err
          .println("CompareDecls: d1 == null && d2 == null (" + _decl1 + " vs. " + _decl2 + ")");
      return true;
    }
    ...
    if (_decl1.disjoint == null && _decl2.disjoint != null) {
      System.err.println(
          "compareDecls: d1.disjoint == null && d2.disjoint != null (" + _decl1 + " vs. " + _decl2
              + ")");
      return false;
    }
    if (_decl1.disjoint != null && _decl2.disjoint == null) {
    ...
    if (_decl1.disjoint2 == null && _decl2.disjoint2 != null) {
      System.err.println(
          "compareDecls: d1.disjoint2 == null && d2.disjoint2 != null (" + _decl1 + " vs. " + _decl2
              + ")");
      return false;
    }
    if (_decl1.disjoint2 != null && _decl2.disjoint2 == null) {
    ...
    if (!compareExpr(_decl1.expr, _decl2.expr)) {
      System.err.println(
          "compareDecl: !compareExpr(d1.expr, d2.expr) (" + _decl1.expr + " vs. " + _decl2.expr
              + ")");
      return false;
    }
    ...
    if (_decl1.isPrivate == null && _decl2.isPrivate != null) {
      System.err.println("compareDecls: d1.isPrivate == null && d2.isPrivate != null ("
          + _decl1.isPrivate + " vs. " + _decl2.isPrivate + ")");
      return false;
    }
    if (_decl1.isPrivate != null && _decl2.isPrivate == null) {
      System.err
          .println("compareDecls: d1.isPrivate != null && d2.isPrivate == null" + _decl1.isPrivate
              + " vs. " + _decl2.isPrivate + ")");
      return false;
    }

    if (_decl1.names.size() != _decl2.names.size()) {
      System.err.println("compareDecls: d1.names.size() != d2.names.size() (" + _decl1.names.size()
          + " vs. " + _decl2.names.size() + ")");
      return false;
    }
    ...
    for (ExprHasName name1 : _decl1.names) {
      ...
      if (!found) {
        System.err.println(
            "compareDecls: decl1.name is not in decl2.names (" + name1 + " vs." + _decl2.names
                + ")");
        return false;
      }
    }
    ...
    for (ExprHasName name2 : _decl2.names) {
      ...
      if (!found) {
        System.err.println(
            "compareDecls: decl2.name is not in decl1.names (" + name2 + " vs." + _decl1.names
                + ")");
        return false;
      }
    }
  ...
  private boolean compareExpr(Expr _expr1, Expr _expr2) {
    ...
    if (_expr1 != null && _expr2 == null) {
      System.err
          .println("compareExpr: expr1 != null && expr2 == null" + _expr1 + " vs. " + _expr2 + ")");
      return false;
    }
    ...
    if (!_expr1.getClass().equals(_expr2.getClass())) {
      System.err.println("expr1.getClass() != expr2.getClass() (" + _expr1.getClass() + " vs. "
          + _expr2.getClass() + ")");
      return false;
    }
    ...
    if (_expr1.getClass().equals(Expr.class)) {
      ...
      if (!compareExprUnary((ExprUnary) _expr1, (ExprUnary) _expr2)) {
        System.err
            .println("compareExpr: !compareExprUnary(" + "(ExprUnary) expr1, (ExprUnary) expr2) "
                + _expr1 + " vs. " + _expr2 + "(" + _expr1 + " vs. " + _expr2 + ")");
        return false;
      }
      ...
      if (!compareSigField((Sig.Field) _expr1, (Sig.Field) _expr2)) {
        System.err.println("compareExpr: !compareSigField("
            + "(Sig.Field) expr1, (Sig.Field) expr2) (" + _expr1 + " vs." + _expr2 + ")");
        System.err.println();
        return false;
      }
    } else if (_expr1.getClass().equals(Sig.class) || _expr1.getClass().equals(Sig.PrimSig.class)) {
      if (!compareSig((Sig) _expr1, (Sig) _expr2)) {
        System.err.println("compareExpr: !compareSig(" + "(Sig) expr1, (Sig) expr2) (" + _expr1
            + " vs." + _expr2 + ")");
        System.err.println();
        return false;
      }
  ...
  private boolean compareExprBinary(ExprBinary _exprbinary1, ExprBinary _exprbinary2) {
    ...
    if (_exprbinary1 == null && _exprbinary2 != null) {
      System.err.println(
          "compareExprBinary: expr1 == null && expr2 != null (" + _exprbinary1 + " vs. "
              + _exprbinary2 + ")");
      return false;
    }
    if (_exprbinary1 != null && _exprbinary2 == null) {
    ...
    if (!compareExpr(_exprbinary1.left, _exprbinary2.left)) {
      System.err.println(
          "ExprBinary: !compareExpr(expr1.left, expr2.left) (" + _exprbinary1.left + " vs. "
              + _exprbinary2.left + ")");
      return false;
    }
    ...
    if (_exprbinary1.op != _exprbinary2.op) {
      System.err
          .println("ExprBinary: expr1.op != expr2.op (" + _exprbinary1.op + " vs. "
              + _exprbinary2.op + ")");
      return false;
    }
    if (!compareExpr(_exprbinary1.right, _exprbinary2.right)) {
      System.err.println("ExprBinary: !compareExpr(expr1.right, expr2.right) (" + _exprbinary1.right
          + " vs. " + _exprbinary2.right + ")");
      return false;
    }
    return true;
  }
  ...
  private boolean compareExprCall(ExprCall _exprcall1, ExprCall _exprcall2) {
    if (_exprcall1 == null && _exprcall2 == null) {
      System.err.println(
          "compareExprCall: expr1 == null && expr2 == null) (" + _exprcall1 + " vs. " + _exprcall2
              + ")");
      return true;
    }
    ...
    if (_exprcall1.args.size() != _exprcall2.args.size()) {
      System.err.println("compareExprCall: expr1.args.size() != expr2.args.size() ( "
          + _exprcall1.args.size() + " vs. " + _exprcall2.args.size() + ")");
      return false;
    }
    ...
    if (_exprcall1.weight != _exprcall2.weight) {
      System.err.println(
          "compareExprCall: different weight. (" + _exprcall1.weight + " vs. " + _exprcall2.weight
              + ")");
      return false;
    }
    ...
    if (!compareFunctions(_exprcall1.fun, _exprcall2.fun)) {
      System.err
          .println("compareExprCall: !compareFunctions(expr1.fun, expr2.fun) (" + _exprcall1.fun
              + " vs. " + _exprcall2.fun + ")");
      return false;
    }
    return true;
  ...
  private boolean compareExprConstant(ExprConstant _exprconstant1, ExprConstant _exprconstant2) {
    if (_exprconstant1 == null && _exprconstant2 == null) {
      System.err.println(
          "compareExprConstant expr1 == null && expr2 == null (" + _exprconstant1 + " vs. "
              + _exprconstant2 + ")");
      return true;
    }
    ...
    if (_exprconstant1.op != _exprconstant2.op) {
      System.err
          .println("ExprConstant: expr1.op != expr2.op (" + _exprconstant1.op + " vs. "
              + _exprconstant2.op + ")");
      return false;
    }
    ...
    if (_exprconstant1.num != _exprconstant2.num) {
      System.err.println(
          "ExprConstant: expr1.num != expr2.num (" + _exprconstant1.num + " vs. "
              + _exprconstant2.num + ")");
      return false;
    }
    ...
    if (!_exprconstant1.string.equals(_exprconstant2.string)) {
      System.err
          .println("ExprConstant: expr1.string != expr2.string (" + _exprconstant1.string + " vs. "
  ...
  private boolean compareExprITE(ExprITE _exprITE1, ExprITE _exprITE2) {
    if (_exprITE1 == null && _exprITE2 == null) {
      System.err.println(
          "compareExprITE: expr1 == null && expr2 == null (" + _exprITE1 + " vs. " + _exprITE2
              + ")");
      return true;
    }
    if (_exprITE1 == null || _exprITE2 == null) {
    ...
    if (!compareExpr(_exprITE1.cond, _exprITE2.cond)) {
      System.err.println("compareExprITE: !compareExpr(expr1.cond, expr2.cond) (" + _exprITE1.cond
          + " vs. " + _exprITE2.cond + ")");
      return false;
    }
    if (!compareExpr(_exprITE1.left, _exprITE2.left)) {
      System.err.println("compareExprITE: !compareExpr(expr1.left, expr2.left) (" + _exprITE1.left
          + " vs. " + _exprITE2.left + ")");
      return false;
    }
    if (!compareExpr(_exprITE1.right, _exprITE2.right)) {
      System.err
          .println("compareExprITE: !compareExpr(expr1.right, expr2.right) (" + _exprITE1.right
              + " vs. " + _exprITE2.right + ")");
      return false;
    }
    return true;
  ...
  private boolean compareExprList(ExprList _exprList1, ExprList _exprList2) {
    ...
    if (_exprList1 != null && _exprList2 == null) {
      System.err.println(
          "compareExprList: " + "expr1 != null && expr2 == null (" + _exprList1 + " vs. "
              + _exprList2 + ")");
      return false;
    }
    if (_exprList1 == null && _exprList2 != null) {
    ...
    if (_exprList1.op != _exprList2.op) {
      System.err
          .println("compareExprList: expr1.op != expr2.op (" + _exprList1.op + " vs. "
              + _exprList2.op + ")");
      return false;
    }
    ...
    if (_exprList1.args.size() != _exprList2.args.size()) {
      System.err.println("compareExprList: " + "expr1.args.size() != expr2.args.size() ("
          + _exprList1.args.size() + " vs. " + _exprList2.args.size() + ")");
      return false;
    }
    // for each expr1.arg
      ...
      for (int j = 0; j < _exprList2.args.size(); j++) {
        ...
        if (compareExprAsString(_exprList1.args.get(i), _exprList2.args.get(j))) {
          if (!compareExpr(_exprList1.args.get(i), _exprList2.args.get(j))) {
            System.err
                .println("compareExprList: expr1.args != expr2.args (" + _exprList1.args.get(i)
                    + " vs. " + _exprList2.args.get(j) + ")");
            found = false;
          } else {
            found = true;
            break;
  ...
  private boolean compareExprQt(ExprQt _exprQt1, ExprQt _exprQt2) {
    ...
    if (_exprQt1.op != _exprQt2.op) {
      System.err
          .println("compareExprQt: expr1.op(" + _exprQt1.op + ") != expr2.op(" + _exprQt2.op + ")");
      return false;
    }
    ...
    if (!compareExpr(_exprQt1.sub, _exprQt2.sub)) {
      System.err.println(
          "compareExprQt: !compareExpr(expr1.sub, expr2.sub) " + _exprQt1.sub + " vs. "
              + _exprQt2.sub);
      return false;
    }
    return true;
  ...
  private boolean compareExprUnary(ExprUnary _exprunary1, ExprUnary _exprunary2) {
    ...
    if (!compareExpr(_exprunary1.sub, _exprunary2.sub)) {
      System.err.println("compareExprUnary: !compareExpr(expr1.sub, expr2.sub) " + _exprunary1.sub
          + " vs. " + _exprunary2.sub);
      return false;
    }
    return true;
  ...
  private boolean compareExprVar(ExprVar _exprVar1, ExprVar _exprVar2) {
    ...
    if (!_exprVar1.label.equals(_exprVar2.label)) {
      System.err.println("compareExprVar: expr1.label != expr2.label (" + _exprVar1.label + " vs. "
          + _exprVar2.label + ")");
      return false;
    }
    if (!compareType(_exprVar1.type(), _exprVar2.type())) {
      System.err.println(
          "compareExprVar: expr1.type() != expr2.type() " + _exprVar1.type() + " vs. "
              + _exprVar2.type());
      return false;
    }
    return true;
  ...
  private boolean compareFunctions(Func _func1, Func _func2) {
    ...
    if (_func1.decls.size() != _func2.decls.size()) {
      System.err.println("compareFunction: " + "func1.decls.size() != func2.decls.size() ("
          + _func1.decls.size() + " vs. " + _func2.decls.size() + ")");
      return false;
    }
      ...
      for (int j = 0; j < _func2.decls.size(); j++) {
        ...
        if (compareDeclAsString(_func1.decls.get(i), _func2.decls.get(j))) {
          if (!compareDecl(_func1.decls.get(i), _func2.decls.get(j))) {
            System.err.println("compareFunction: !compareDecl (func.decls). " + _func1.decls.get(i)
                + " and " + _func2.decls.get(j) + "has a same string but different as Decl");
            return false;
          }
        }
      }
    ...
    if (_func1.isPred != _func2.isPred) {
      System.err.println(
          "compareFunction: func1.isPred != func2.isPred " + _func1.isPred + " vs. "
              + _func2.isPred);
      return false;
    }
    ...
    if (!AlloyUtils.removeSlash(_func1.label).equals(AlloyUtils.removeSlash(_func2.label))) {
      System.err
          .println("compareFunctions: label is different. (" + AlloyUtils.removeSlash(_func1.label)
              + " vs. " + AlloyUtils.removeSlash(_func2.label) + ")");
      System.err.println();
      return false;
    }
    if (!compareExpr(_func1.returnDecl, _func2.returnDecl)) {
      System.err.println("compareFunctions: " + "!compareExpr(func1.returnDecl, func2.returnDecl) "
          + _func1.returnDecl + " vs. " + _func2.returnDecl);
      return false;
    }
    if (!compareExpr(_func1.getBody(), _func2.getBody())) {
      System.err.println("!compareExpr(func1.getBody(), func2.getBody()) " + _func1.getBody()
          + " vs. " + _func2.getBody());
      return false;
    }
    return true;
  ...
  private boolean comparePrimSig(PrimSig _primSig1, PrimSig _primSig2) {
    ...
    if (_primSig1.children().size() != _primSig2.children().size()) {
      System.err.println("comparePrimSig: primSig1(" + _primSig1 + ").children().size()("
          + _primSig1.children().size() + ") != primSig2(" + _primSig2 + ").children().size() ("
  ...
  private boolean compareSig(Sig _sig1, Sig _sig2) {
    ...
    if (_sig1 == null && _sig2 != null) {
      System.err
          .println("compareSig: sig1 == null && sig2 != null (" + _sig1 + " vs. " + _sig2 + ")");
      return false;
    }
    if (_sig1 != null && _sig2 == null) {
      System.err
    ...
    if (_sig1 instanceof Sig.PrimSig && _sig2 instanceof Sig.PrimSig
    ...
    if (_sig1.attributes.size() != _sig2.attributes.size()) {
      System.err.println("compareSig: sig1.attributes.size() != sig2.attributes.size() ("
          + _sig1.attributes.size() + " vs. " + _sig2.attributes.size() + ")");
      return false;
    }
    ...
    for (int i = 0; i < _sig1.attributes.size(); i++) {
      if (_sig1.attributes.get(i) == null && _sig2.attributes.get(i) == null)
        continue;
        ...
        System.err
            .println("compareSig: !compareAttr(sig1.attributes.get(i), sig2.attributes.get(i))"
                + _sig1.attributes.get(i) + " vs. " + _sig2.attributes.get(i));
        return false;
      }
    }
    ...
    if (!AlloyUtils.removeSlash(_sig1.label).equals(AlloyUtils.removeSlash(_sig2.label))) {
      System.err.println("compareSig: !sig1.label.equals(sig2.label) "
          + AlloyUtils.removeSlash(_sig1.label) + " vs. " + AlloyUtils.removeSlash(_sig2.label));
      return false;
    }
    if (_sig1.getDepth() != _sig2.getDepth()) {
      System.err.println("compareSig: sig1.getDepth() != sig2.getDepth() " + _sig1.getDepth()
          + " vs. " + _sig2.getDepth());
      return false;
    }
    ...
    if (_sig1.getFacts().size() != _sig2.getFacts().size()) {
      System.err.println("compareSig: sig1.getFacts().size() != sig2.getFacts().size() ("
          + _sig1.getFacts().size() + " vs. " + _sig2.getFacts().size() + ")");
      return false;
    }
    ...
    if (_sig1.getFieldDecls().size() != _sig2.getFieldDecls().size()) {
      System.err.println("compareSig: sig1.getFieldDecls().size() != sig2.getFieldDecls().size() ("
          + _sig1.getFieldDecls().size() + " vs. " + _sig2.getFieldDecls().size() + ")");
      return false;
    }
    ...
    for (Decl decl1 : _sig1.getFieldDecls()) {
      ...
      if (!found) {
        System.err
            .println("compareSig: fieldDecls " + decl1 + " not found in " + _sig2.getFieldDecls());
        return false;
      }
    }
    ...
    if (_sig1.getFields().size() != _sig2.getFields().size()) {
      System.err.println("compareSig: sig1.getFields().size() != sig2.getFields().size() ("
          + _sig1.getFields().size() + " vs. " + _sig2.getFields().size() + ")");
      return false;
    }
    ...
    if (_sig1.isTopLevel() != _sig2.isTopLevel()) {
      System.err.println("compareSig: sig1.isTopLevel() != sig2.isTopLevel() (" + _sig1.isTopLevel()
          + " vs. " + _sig2.isTopLevel() + ")");
      return false;
    }
    if (!AlloyUtils.removeSlash(_sig1.toString())
      ...
      System.err.println("compareSig: !sig1.toString().equals(sig2.toString()) ("
          + AlloyUtils.removeSlash(_sig1.toString()) + " vs. "
  ...
  private boolean compareSigField(Field _field1, Field _field2) {
    ...
    if (!AlloyUtils.removeSlash(_field1.label).equals(AlloyUtils.removeSlash(_field2.label))) {
      System.err
          .println("Sig.Field: sig1.label != sig2.label (" + AlloyUtils.removeSlash(_field1.label)
              + " vs. " + AlloyUtils.removeSlash(_field2.label) + ")");
      return false;
    }

    if (_field1.defined != _field2.defined) {
      System.err.println("Sig.Field: sig1.defined != sig2.defined (" + _field1.defined + " vs. "
          + _field2.defined + ")");
      return false;
    }
    ...
    if ((_field1.isPrivate == null && _field2.isPrivate != null)
      ...
      System.err.println("Sig.Field: isPrivate different (" + _field1.isPrivate + " vs. "
          + _field2.isPrivate + ")");
      return false;
    }
    return true;
