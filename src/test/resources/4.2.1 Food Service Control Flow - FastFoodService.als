//*****************************************************************
// Module: 		Food Service Control Flow - Fast Food Service
...
/** Model closure */
fact {all x: FastFoodService | x.steps in x.eat + x.order + x.pay + x.prepare + x.serve}
fact {all x: FastFoodService | no x.inputs}
fact {all x: FastFoodService | no inputs.x}
fact {all x: FastFoodService | no x.outputs}
fact {all x: FastFoodService | no outputs.x}
fact {all x: FastFoodService | no items.x}
fact {all x: FastFoodService | no steps.x}
fact {all x: FastFoodService | no y: Transfer | y in x.steps}
//******************************************************************************************************
/** 			General Functions and Predicates */
//******************************************************************************************************
pred instancesDuringExample{all x: (Eat + Order + Pay + Prepare + Serve) | x in FastFoodService.steps}
//******************************************************************************************************
/** 				Checks and Runs */
...
//******************************************************************************************************
run showFastFoodService{instancesDuringExample and some FastFoodService and FoodService in FastFoodService and no BinaryLink} for 10
