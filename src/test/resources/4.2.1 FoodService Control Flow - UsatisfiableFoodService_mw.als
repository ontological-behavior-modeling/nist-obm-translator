...
//MW -
//change main class name to ChurchSupperService UnsatisfiableService because OBM_Model_R.xmi uses the name 
//change module name from ChurchSupperService to UnsatisfiableService because API uses main class name as the modulename

//UsatisfiableFoodService
module UnsatisfiableService
...
//*****************************************************************
/**	Definition */
sig UnsatisfiableService extends SingleFoodService{}{
	/*bijectionFiltered[happensBefore, eat, pay]
	bijectionFiltered[happensBefore, pay, prepare]*/
}
fact {all x: UnsatisfiableService | bijectionFiltered[happensBefore, x.eat, x.pay]}
fact {all x: UnsatisfiableService | bijectionFiltered[happensBefore, x.pay, x.prepare]}
