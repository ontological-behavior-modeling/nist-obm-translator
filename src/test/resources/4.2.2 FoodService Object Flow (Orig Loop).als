...
//***********************************************************************************************************
module FoodServiceObjectFlowControlLoop
...
//***********************************************************************************************************
sig OFControlLoopFoodService extends Occurrence{
	start: one OFStart,
	end: one OFEnd,
...
/** Constraints on OFControlLoopFoodService */
	...
	start + end + order + pay + prepare + serve + eat + transferOrderPrepare + 
	transferPrepareServe + transferServeEat + transferOrderPay + transferPayEat in this.steps
	this.steps in order + start + end + pay + prepare + serve + eat + transferOrderPrepare + 
...
/** Constraints on process steps */
	...
	// Set up the target of the overall loop
...
//	functionFiltered[outputs, pay, FoodItem]	// Changed this. Not sure why it was a function. May have to change back.
	...
	// Set up the source of the overall loop
...
pred instancesDuringExample{Order in OFControlLoopFoodService.order && Prepare in OFControlLoopFoodService.prepare &&
		Serve in OFControlLoopFoodService.serve && Eat in OFControlLoopFoodService.eat && Pay in OFControlLoopFoodService.pay}
//***********************************************************************************************************
/** 				Checks and Runs */
//***********************************************************************************************************
run showOFControlLoopFoodService{nonZeroDurationOnly && instancesDuringExample} for 29 but exactly 1 OFControlLoopFoodService, 5 int
