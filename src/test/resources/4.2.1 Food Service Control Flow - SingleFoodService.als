//*****************************************************************
// Module: 		Food Service Control Flow - Single Food Service
...
//*****************************************************************
module SingleFoodServiceModule
...
/** Model closure */
fact {all x: SingleFoodService | x.steps in x.eat + x.order + x.pay + x.prepare + x.serve}
fact {all x: SingleFoodService | no x.inputs}
fact {all x: SingleFoodService | no inputs.x}
fact {all x: SingleFoodService | no x.outputs}
fact {all x: SingleFoodService | no outputs.x}
fact {all x: SingleFoodService | no items.x}
fact {all x: SingleFoodService | no steps.x}
fact {all x: SingleFoodService | no y: Transfer | y in x.steps}
//******************************************************************************************************
/** 			General Functions and Predicates */
//******************************************************************************************************
pred instancesDuringExample{all x: (Eat + Order + Pay + Prepare + Serve) | x in SingleFoodService.steps}
//******************************************************************************************************
/** 				Checks and Runs */
...
//******************************************************************************************************
run showSingleFoodService{instancesDuringExample and some SingleFoodService and FoodService in SingleFoodService and no BinaryLink} for 10
