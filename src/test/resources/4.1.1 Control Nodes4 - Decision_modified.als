...
fact {all x: BehaviorDecision | functionFiltered[happensBefore, x.p1, x.p2 + x.p3]}
fact {all x: BehaviorDecision | inverseFunctionFiltered[happensBefore, x.p1, x.p2 + x.p3]}
