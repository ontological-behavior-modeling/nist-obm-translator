...
//***********************************************************************************************************
sig OFControlLoopFoodService extends OFFoodService{
	start: one OFStart,
	end: one OFEnd,
...
/** Constraints on OFControlLoopFoodService */
	...
	this.steps in start + end + order + pay + prepare + serve + eat + transferOrderPrepare + 
...
pred instancesDuringExample{Order in OFControlLoopFoodService.order && Prepare in OFControlLoopFoodService.prepare &&
		...
		Transfer in OFControlLoopFoodService.steps && FoodService in OFControlLoopFoodService}
//***********************************************************************************************************
/** 				Checks and Runs */
//***********************************************************************************************************
run showOFControlLoopFoodService{nonZeroDurationOnly && instancesDuringExample} for 32 but exactly 1 OFControlLoopFoodService, 6 int
