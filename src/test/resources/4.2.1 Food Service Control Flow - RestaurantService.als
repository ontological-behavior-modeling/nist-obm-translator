//*****************************************************************
// Module: 		Food Service Control Flow - Restaurant Service
...
//*****************************************************************
module RestaurantServiceModule
...
/** Model closure */
fact {all x: RestaurantService | x.steps in x.eat + x.order + x.pay + x.prepare + x.serve}
fact {all x: RestaurantService | no x.inputs}
fact {all x: RestaurantService | no inputs.x}
fact {all x: RestaurantService | no x.outputs}
fact {all x: RestaurantService | no outputs.x}
fact {all x: RestaurantService | no items.x}
fact {all x: RestaurantService | no steps.x}
fact {all x: RestaurantService | no y: Transfer | y in x.steps}
//******************************************************************************************************
/** 			General Functions and Predicates */
//******************************************************************************************************
pred instancesDuringExample{all x: (Eat + Order + Pay + Prepare + Serve) | x in RestaurantService.steps}
//******************************************************************************************************
/** 				Checks and Runs */
...
//******************************************************************************************************
run showRestaurantService{instancesDuringExample and some RestaurantService and FoodService in RestaurantService and no BinaryLink} for 10
